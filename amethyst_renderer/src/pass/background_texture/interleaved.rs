...
/// Draw a texture on the background with tiling
///
...
#[derivative(Default(bound = "V: Query<()>, Self: Pass"))]
pub struct DrawBackgroundTexture<V> {
    _pd: PhantomData<V>,
    transparency: Option<(ColorMask, Blend, Option<DepthMode>)>,
}

impl<V> DrawBackgroundTexture<V>
where
    V: Query<()>,
    Self: Pass,
{
    /// Create instance of `DrawBackgroundTexture` pass
    pub fn new() -> Self {
        Default::default()
    }
...
impl<'a, V> PassData<'a> for DrawBackgroundTexture<V>
where
    V: Query<()>,
{
    type Data = (
...
impl<V> Pass for DrawBackgroundTexture<V>
where
    V: Query<()>,
{
